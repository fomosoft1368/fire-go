...
export class PaymentService {
  private vnpayConfig: VNPayConfig = {
    ...
    returnUrl: process.env.VNPAY_RETURN_URL || `http://192.168.1.12:${process.env.PORT || 3000}/api/payment/vnpay/return`,
    notifyUrl: process.env.VNPAY_NOTIFY_URL || `http://192.168.1.12:${process.env.PORT || 3000}/api/payment/vnpay/notify`,
  }
