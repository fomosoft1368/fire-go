...
export class PaymentMethodController {
  ...
  async updatePaymentMethod(
    ...
    return this.paymentMethodService.updatePaymentMethod(id, req.user?.sub, dto)
  }

  @Delete(':id')
  @UseGuards(JwtAuthGuard)
  @HttpCode(HttpStatus.NO_CONTENT)
  async deletePaymentMethod(@Request() req: any, @Param('id') id: string): Promise<void> {
  ...
  async setDefaultPaymentMethod(
    ...
    console.log('[PaymentMethod] Set Default - User:', req.user?.sub, 'Method:', id)
