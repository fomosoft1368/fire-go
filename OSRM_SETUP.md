...
```bash
curl "http://localhost:5000/route/v1/driving/106.6626,10.6644;106.6763,10.7743?geometries=geojson&overview=full"
```
...
Backend: CombinedTripsService.getDirections()
    ↓
http://localhost:5000/route/v1/driving/...  ← Local OSRM (Vietnam only!)
    ↓
