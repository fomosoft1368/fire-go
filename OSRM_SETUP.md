...
<<<<<<< Updated upstream
curl http://192.168.1.15:5000/status
=======
...
# Existing settings...
<<<<<<< Updated upstream
OSRM_BASE_URL=http://192.168.1.15:5000
=======
...
```bash
<<<<<<< Updated upstream
curl "http://192.168.1.15:5000/route/v1/driving/106.6626,10.6644;106.6763,10.7743?geometries=geojson&overview=full"
=======
...
Backend: CombinedTripsService.getDirections()
    ↓
<<<<<<< Updated upstream
http://192.168.1.15:5000/route/v1/driving/...  ← Local OSRM (Vietnam only!)
=======
