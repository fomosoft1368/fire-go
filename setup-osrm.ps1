...
try {
    ...
    Write-Host "   Port: http://192.168.1.15:5000" -ForegroundColor Gray
}
catch {
...
try {
    $response = Invoke-WebRequest -Uri "http://192.168.1.15:5000/status" -TimeoutSec 10
    ...
    Write-Host "   Check status manually: curl http://192.168.1.15:5000/status" -ForegroundColor Gray
}
...
<<<<<<< Updated upstream
Write-Host "  1. Backend .env already has: OSRM_BASE_URL=http://192.168.1.15:5000" -ForegroundColor Gray
=======
...
<<<<<<< Updated upstream
Write-Host "   Test endpoint:   curl 'http://192.168.1.15:5000/route/v1/driving/106.6626,10.6644;106.6763,10.7743?geometries=geojson'" -ForegroundColor Gray
=======
