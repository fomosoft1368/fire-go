      ...
      <aside className="w-64 bg-white dark:bg-card-dark border-r border-slate-200 dark:border-slate-800 flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/user-management')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
            <span className={`material-symbols-outlined ${isActive('/user-management') ? 'filled' : ''}`}>manage_accounts</span>
            <span className="font-semibold">  Người dùng</span>
          </button>

          <button
            onClick={() => navigate('/marketing')}
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/marketing')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
            <span className={`material-symbols-outlined ${isActive('/marketing') ? 'filled' : ''}`}>group</span>
            <span className="font-semibold">Đội ngũ Marketing</span>
          </button>

          <button
            onClick={() => navigate('/drivers')}
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/drivers')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/driver-approval')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/rides')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/customers')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/revenue')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/transactions')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/pricing-config')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/driver-search-settings')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/dispatch')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/notifications')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/reports')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/hourly-service-workers')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/hourly-services')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/addon-services')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/legal-documents')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/bonus-management')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/system-logs')
                ? 'bg-primary text-white shadow-md shadow-primary/20'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
              }`}
          >
            <span className={`material-symbols-outlined ${isActive('/system-logs') ? 'filled' : ''}`}>bug_report</span>
            <span className="font-semibold whitespace-nowrap">Theo dõi lỗi Hệ thống</span>
          </button>
        ...
        <header className="h-16 bg-white dark:bg-card-dark border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-6">
          <div className="flex items-center gap-4">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">
              ...
              {location.pathname === '/system-logs' && 'Theo dõi lỗi (System Logs)'}
            </h2>
          </div>
